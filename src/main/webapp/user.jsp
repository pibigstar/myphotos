								...
								<div class="row">
									<div class="col-md-10 col-md-offset-1">
										<div class="form-group">
											<label>用户名：</label> <input type="text" value="${user.username }" class="form-control" readonly="readonly">
										</div>
										<div class="form-group">
											<label>密码:</label><input type="password" value="${user.password }" class="form-control" readonly="readonly">
										</div>
										<div class="form-group">
                                            <label>昵称：</label> <input type="text" value="${user.nick }" class="form-control" placeholder="请输入你的昵称">
                                        </div>
										<div class="form-group">
											<label>头像:</label> 
										...
										<div class="form-group">
                                            <label>邮箱：</label> <input type="text" value="${user.email }" class="form-control" placeholder="请输入你的邮箱">
                                        </div>
                                        <div class="form-group">
                                            <label>手机号：</label> <input type="text" value="${user.phone }" class="form-control" placeholder="请输入你的手机号">
                                        </div>
                                        <div class="form-group">
                                            <label>地址：</label> <input type="text" value="${user.address }" class="form-control" placeholder="请输入你的地址">
                                        </div>
